...
public class Main {
    ...
    private static void userSession() throws Exception {
        ...
        while (loggedIn) {
            ...
            System.out.println("4. Golden Hour System");
            ...
            switch (choice) {
                ...
                case "3":
                    ...
                    SalesSystem.SalesSystem(currentUser.getID());
                    break;
                case "4":
                    GoldenHourStoreSystem.main(new String[0]);
                    break;
                case "5":
                    if (currentUser.getRole().equalsIgnoreCase("manager")) {
                        handleRegistration();
